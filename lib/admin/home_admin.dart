                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      Padding(padding: EdgeInsets.all(6.0),
                        child: Image.asset("assets/camp.png", height: 100, width: 100, fit: BoxFit.cover,),),
                      SizedBox(width: 30.0,) ,
                      Text("Add Outgear Items", style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold),) ],),
                  ),
                ),
              ),
            )
